...
export class AddExpenseDialogComponent implements OnInit {
  ...
  constructor(public dialog: MatDialog, public dialogRef: MatDialogRef<AddExpenseDialogComponent>, private httpService: HttpServiceService, private formBuilder: UntypedFormBuilder, private snackBService: SnackBarService, @Inject(MAT_DIALOG_DATA) public data: { operation: any, id: any, categoryname: any }) { }
  ...
  onBuildForm() {
    this.addexpenseForm = this.formBuilder.group({
      ...
      description: [''],
      // date: [{value:'', disabled: this.data.operation== 'edit'? true : false }],
  ...
  getExpenseCategory() {
    this.httpService.get('payment-expense-category', false)
      .subscribe(result => {
        if (result.status == 200) {
