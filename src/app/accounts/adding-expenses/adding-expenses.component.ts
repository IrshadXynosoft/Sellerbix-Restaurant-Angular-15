...
@Component({
  selector: 'app-adding-expenses',
  templateUrl: './adding-expenses.component.html',
  styleUrls: ['./adding-expenses.component.scss']
})
export class AddingExpensesComponent implements OnInit, AfterViewInit {
  ...
  getExpenseCategory() {
    this.httpService.get('payments/0')
      .subscribe(result => {
