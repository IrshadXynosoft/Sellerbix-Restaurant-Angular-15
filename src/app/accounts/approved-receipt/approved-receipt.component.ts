...
@Component({
  ...
  templateUrl: './approved-receipt.component.html',
  styleUrls: ['./approved-receipt.component.scss']
})
export class ApprovedReceiptComponent implements OnInit {
  ...
  getExpenseCategory() {
    this.httpService.get('receipts/1')
      .subscribe(result => {
